  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <aside
        ref={ref}
        className={cn(
          'relative hidden h-screen flex-col border-r bg-background transition-none md:flex sidebar',
    ...
    const buttonContent = (
      <span
        ...
        className={cn(
          ...
          'w-full justify-start transition-colors duration-200 hover:bg-[#E3F2FD] hover:text-accent-foreground',
          isActive && 'bg-[#4A90E2] text-white hover:bg-[#4A90E2]/90',
